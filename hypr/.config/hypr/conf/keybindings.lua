...
hl.bind(mainMod .. " + P",          hl.dsp.exec_cmd(programs.screenshotRegion))
hl.bind(mainMod .. " +SHIFT + P",   hl.dsp.exec_cmd(programs.screenshotWindow))
hl.bind(mainMod .. " + CTRL + L",   hl.dsp.exec_cmd(programs.lockscreen))
hl.bind(mainMod .. " + SHIFT + C",  hl.dsp.exec_cmd(programs.colorpicker))
