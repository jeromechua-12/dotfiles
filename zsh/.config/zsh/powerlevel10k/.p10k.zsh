# Generated by Powerlevel10k configuration wizard on 2026-05-06 at 20:57 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=$python
  # Show Python version.
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL=' '  # add a space at the left end of left prompt.

  # Context format when root: user@host. The whole thing white. 
  ...
  # Lavender Git prompt. This makes stale prompts indistinguishable from up-to-date ones.
